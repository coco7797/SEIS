...
VIOLATION_PROMPTS = {
    ...
    "head_pose": (
        ...
        "away from their own exam paper in a suspicious cheating manner.\n\n"
        ...
        "DECISION RULES:\n"
        "- CONFIRMED: Only mark as CONFIRMED if the student is clearly turning their head "
        "towards an adjacent desk, another student's exam paper, or unauthorized notes/materials "
        "placed beside them or on their lap. Looking specifically at another desk, person's paper, "
        "or hidden notes is strong evidence of cheating.\n"
        "- DO NOT CONFIRM / FALSE_POSITIVE: If the student is just looking around the room "
        "(e.g., staring into space, looking at the ceiling, looking around the room in thought, "
        "looking toward a blank wall or window) and NOT looking at another paper or desk, this must "
        "NOT be marked as CONFIRMED. Mark it as FALSE_POSITIVE.\n"
        "- Also mark as FALSE_POSITIVE if the student is clearly looking straight at their own exam "
        "paper directly in front of them, looking at the front board/clock, or visibly speaking to an invigilator.\n"
        "- INCONCLUSIVE: If you are UNSURE, uncertain, or the camera angle/lighting makes it difficult "
        "to clearly determine whether the student is looking at another paper/desk versus just looking "
        "around the room, you MUST give an INCONCLUSIVE verdict. Let the human invigilator review ambiguous cases.\n\n"
        "Respond with EXACTLY this format:\n"
        "VERDICT: [CONFIRMED or FALSE_POSITIVE or INCONCLUSIVE]\n"
    ...
    "eye_tracking": (
        ...
        "DECISION RULES:\n"
        "- CONFIRMED: Only mark as CONFIRMED if the student's eyes or gaze are specifically directed "
        "towards an adjacent desk, another student's exam paper, or unauthorized notes/materials beside them. "
        "Reading or looking sideways toward an adjacent desk, another student's work, or notes/paper beside him "
        "is strong evidence of cheating, even if the student next to him is not in frame.\n"
        "- DO NOT CONFIRM / FALSE_POSITIVE: If the student is just looking around the room "
        "(e.g., gazing into space in thought, looking around the room generally, glancing up at the ceiling "
        "or wall) and NOT targeting another paper or desk, this must NOT be marked as CONFIRMED. "
        "Mark it as FALSE_POSITIVE.\n"
        "- Also mark as FALSE_POSITIVE if the student is clearly focused straight ahead on their own exam "
        "paper or looking up at the front of the room, board, or clock.\n"
        "- INCONCLUSIVE: If you are UNSURE, uncertain, or the student's eye direction makes it ambiguous "
        "whether their gaze is directed at another paper/desk versus just wandering around the room, "
        "you MUST give an INCONCLUSIVE verdict. Let the human invigilator review ambiguous cases.\n\n"
        "Respond with EXACTLY this format:\n"
        "VERDICT: [CONFIRMED or FALSE_POSITIVE or INCONCLUSIVE]\n"
        "REASONING: [One or two sentences explaining your decision]"
    ),
